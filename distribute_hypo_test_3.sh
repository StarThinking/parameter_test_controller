...
do
    ...
    ssh hadoop-$hadoop_index "cd parameter_test_controller; java Hypothesis $line0 > /dev/null; sleep 60; java Hypothesis $line1 > /dev/null; sleep 60; java Hypothesis $line2 > /dev/null > /dev/null &" &
